...
For a detailed technical reference on MCP implementation with Claude Desktop, see [Desktop Commander MCP Reference](/docs/reference/desktop-commander-mcp-reference.md).
